...
const Contact = () => {
  return (
      <div className="max-w-5xl w-full mx-auto p-10 text-gray-800 py-16">
            <span className="px-2 py-1 text-secondary text-xs border border-gray-300 rounded-full">Reach Out To Us</span>
            <h1 className="text-4xl font-bold text-left mt-4">
                We'd love to Hear From You.
            </h1>
            <p className="text-left mt-4">
                Or just reach out manually to
                <a href="mailto:yashitagupta427@gmail.com" className="text-primary hover:underline"> yashitagupta427@gmail.com</a>
            </p>
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    <svg className="text-secondary bg-primary p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <a href="yashitagupta427@gmail.com" className="text-primary font-semibold">
                        yashitagupta427@gmail.com
                    </a>
                </div>
                <div>
                    <svg className="text-secondary bg-primary p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <span className="text-primary font-semibold">
                        BY Mapp , Sector 22 , Gurgaon
                    </span>
                </div>
                <div>
                    <svg className="text-secondary bg-primary p-2.5 aspect-square rounded-full size-10" width="21"
